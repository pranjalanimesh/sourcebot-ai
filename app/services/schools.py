...
def schools(user_query: str) -> SchoolsModel:
    """You have good knowledge of different schools and colleges. You have make the list of all the schools or universities mentioned in the given user query. List the names in lowercase. Include variants of the name of school if any."""
